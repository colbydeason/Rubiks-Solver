...
FACEF = [FTL, FTM, FTR, FML, FMM, FMR, FBL, FBM, FBR]
FACER = [RTL, RTM, RTL, RML, RMM, RMR, RBL, RBM, RBR]
FACEL = [LTL, LTM, LTR, LML, LMM, LMR, LBL, LBM, LBR]
FACEB = [BTL, BTM, BTR, BML, BMM, BMR, BBL, BBM, BBR]
